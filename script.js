    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "N.C.S בדק בית ופיקוח בנייה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '04844d08-d73c-4ec5-bc7c-275a51a80eb4',
                    name: data.name || '',
                    email: data.email || '',
